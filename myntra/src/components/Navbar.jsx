...
const Navbar = () => {
    ...
    // console.log(userData, "user here")
            ...
            <div id="navbar">
                ...
                <div class="navright">
                    ...
                    <div>
                        ...
                        {userData?.role == "Seller" && <div onClick={ () => router('/add-product')} style={{ fontWeight:"bold"}}>Add </div>}
                        {userData?.role == "Buyer" && <div onClick={ ()=> router('/cart')}>
                            <i class="fa-solid fa-bag-shopping"></i>
                            <h4 onClick={ ()=> router('/cart')}>Bag</h4>
                        </div>}
